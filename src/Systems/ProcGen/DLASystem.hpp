#ifndef SRC_SYS_PROCGEN_DIFFUSSIONLIMITEDAGGREGATION_HPP_
#define SRC_SYS_PROCGEN_DIFFUSSIONLIMITEDAGGREGATION_HPP_
...
#endif // SRC_SYS_PROCGEN_DIFFUSSIONLIMITEDAGGREGATION_HPP_