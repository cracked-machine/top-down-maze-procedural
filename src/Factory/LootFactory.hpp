...
inline entt::entity createLootDrop( entt::registry &registry, Cmp::SpriteAnimation &&loot_anim_cmp, sf::FloatRect search,
                                    Sys::BaseSystem::IncludePack<Include...>, Sys::BaseSystem::ExcludePack<Exclude...> )
{
