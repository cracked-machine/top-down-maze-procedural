                  ...
                  int sequence, int zorder )
{
  ...
  auto &fuse_delay = Sys::PersistSystem::get_persist_cmp<Cmp::Persistent::FuseDelay>( registry );
  auto &armed_on_delay = Sys::PersistSystem::get_persist_cmp<Cmp::Persistent::ArmedOnDelay>( registry );
  auto &armed_off_delay = Sys::PersistSystem::get_persist_cmp<Cmp::Persistent::ArmedOffDelay>( registry );
