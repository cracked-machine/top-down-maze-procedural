...
void BaseShader::load_shader_files()
{
...
void BaseShader::setPosition( const sf::Vector2f &position ) { set_position( position ); }
void BaseShader::set_texture_view( sf::View view_update ) { m_render_texture.setView( view_update ); }
void BaseShader::resize_texture( sf::Vector2u new_size )
{
