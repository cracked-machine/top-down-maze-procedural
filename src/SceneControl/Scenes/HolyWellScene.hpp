...
private:
  ...
  sf::Vector2f m_player_start_position = Utils::snap_to_grid(
      sf::Vector2f( ( HolyWellScene::kMapGridSizeF.x / 2.f ) * Constants::kGridSquareSizePixels.x - Constants::kGridSquareSizePixels.x,
                    ( HolyWellScene::kMapGridSizeF.y - 2.f ) * Constants::kGridSquareSizePixels.y ) );
};
