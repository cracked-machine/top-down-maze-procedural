#ifndef SRC_COMPONENTS_WORMHOLE_WORMHOLEMULTIBLOCK_HPP__
#define SRC_COMPONENTS_WORMHOLE_WORMHOLEMULTIBLOCK_HPP__
...
#endif // SRC_COMPONENTS_WORMHOLE_WORMHOLEMULTIBLOCK_HPP__
