#ifndef SRC_COMPONENTS_HOLYWELL_HOLYWELLSEGMENT_HPP__
#define SRC_COMPONENTS_HOLYWELL_HOLYWELLSEGMENT_HPP__
...
#endif // SRC_COMPONENTS_HOLYWELL_HOLYWELLSEGMENT_HPP__
