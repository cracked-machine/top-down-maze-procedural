#ifndef SRC_COMPONENTS_CRYPTINTERIORMULTIBLOCK_HPP__
#define SRC_COMPONENTS_CRYPTINTERIORMULTIBLOCK_HPP__
...
#endif // SRC_COMPONENTS_CRYPTINTERIORMULTIBLOCK_HPP__