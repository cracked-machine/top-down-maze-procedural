#ifndef SRC_COMPONENTS_PLAYER_PLAYERLEVELDEPTH_HPP__
#define SRC_COMPONENTS_PLAYER_PLAYERLEVELDEPTH_HPP__
...
#endif // SRC_COMPONENTS_PLAYER_PLAYERLEVELDEPTH_HPP__
