#ifndef SRC_COMPONENTS_PLAYER_PLAYERCADAVERCOUNT_HPP__
#define SRC_COMPONENTS_PLAYER_PLAYERCADAVERCOUNT_HPP__
...
#endif // SRC_COMPONENTS_PLAYER_PLAYERCADAVERCOUNT_HPP__
