#ifndef SRC_COMPONENTS_PARTICLE_EATINGCRUMBSPARTICLESPRITE_HPP__
#define SRC_COMPONENTS_PARTICLE_EATINGCRUMBSPARTICLESPRITE_HPP__
...
struct EatingCrumbsParticle : public Cmp::Particle::ParticleBase
{
...
class EatingCrumbsParticleSprite : public SpriteBase<detail::EatingCrumbsParticle>
{
public:
  //! @brief Construct a new Obstacle Dig Particle Sprite object
  //! @param count Number of particles in this sprite
  EatingCrumbsParticleSprite( size_t count );
...
#endif // SRC_COMPONENTS_PARTICLE_EATINGCRUMBSPARTICLESPRITE_HPP__
