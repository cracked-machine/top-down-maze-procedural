...
namespace detail
{
void PlayerHealingParticle::emit()
{
...
PlayerHealingParticleSprite::PlayerHealingParticleSprite( size_t count )
    : SpriteBase( count ) {};

void PlayerHealingParticleSprite::simulate( sf::Time dt )
{
...
//! @param target
//! @param states
void PlayerHealingParticleSprite::draw( sf::RenderTarget &target, sf::RenderStates states ) const
{
