#ifndef __CMP__SPAWN_AREA_SPRITE_HPP__
#define __CMP__SPAWN_AREA_SPRITE_HPP__

#include <Sprites/MultiSprite.hpp>

namespace ProceduralMaze::Cmp {

class SpawnAreaSprite
{
public:
  SpawnAreaSprite( Sprites::SpriteMetaType type, std::size_t tile_index, bool solid_mask )
      : m_type( type ),
...
#endif // __CMP__SPAWN_AREA_SPRITE_HPP__