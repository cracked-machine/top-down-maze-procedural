#ifndef SRC_COMPONENTS_CRYPT_INTERIORSEGMENT_HPP__
#define SRC_COMPONENTS_CRYPT_INTERIORSEGMENT_HPP__

namespace Game::Cmp::Crypt
{

//! @brief Marks a single 16x16 px block of a Cmp::Crypt::InteriorMultiBlock, mainly used to distinguish
//! between individual interior segments for the purpose of collision detection.
class InteriorSegment
{
public:
  //! @brief Construct a new segment.
  //! @param solid_mask Initial collision-enabled state for this segment.
  InteriorSegment( bool solid_mask )
...
#endif // SRC_COMPONENTS_CRYPT_INTERIORSEGMENT_HPP__
