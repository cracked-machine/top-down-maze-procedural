#ifndef SRC_COMPONENTS_CRYPT_CRYPTOBJECTIVEMULTIBLOCK_HPP__
#define SRC_COMPONENTS_CRYPT_CRYPTOBJECTIVEMULTIBLOCK_HPP__
...
#endif // SRC_COMPONENTS_CRYPT_CRYPTOBJECTIVEMULTIBLOCK_HPP__
