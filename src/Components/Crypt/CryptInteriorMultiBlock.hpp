#ifndef SRC_COMPONENTS_CRYPT_CRYPTINTERIORMULTIBLOCK_HPP__
#define SRC_COMPONENTS_CRYPT_CRYPTINTERIORMULTIBLOCK_HPP__
...
// CryptInteriorMultiBlock component represents a multi-block sprite defined geometrically as a rectangle
// It can be used to find its CryptSegment parts and track overall activation state
class CryptInteriorMultiBlock : public sf::FloatRect
{
public:
  CryptInteriorMultiBlock( const sf::Vector2f &position, const sf::Vector2f &size )
...
#endif // SRC_COMPONENTS_CRYPT_CRYPTINTERIORMULTIBLOCK_HPP__
