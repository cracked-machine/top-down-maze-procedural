#ifndef SRC_COMPONENTS_CRYPT_CRYPTINTERIORSEGMENT_HPP__
#define SRC_COMPONENTS_CRYPT_CRYPTINTERIORSEGMENT_HPP__
...
#endif // SRC_COMPONENTS_CRYPT_CRYPTINTERIORSEGMENT_HPP__
