#ifndef SRC_COMPONENTS_CRYPT_CRYPTOBJECTIVESEGMENT_HPP__
#define SRC_COMPONENTS_CRYPT_CRYPTOBJECTIVESEGMENT_HPP__

namespace Game::Cmp
{

// Mainly used to distinguish between 16x16 block crypt segments for the purpose of collision detection
class CryptObjectiveSegment
{
public:
  CryptObjectiveSegment( bool solid_mask )
...
#endif // SRC_COMPONENTS_CRYPT_CRYPTOBJECTIVESEGMENT_HPP__
