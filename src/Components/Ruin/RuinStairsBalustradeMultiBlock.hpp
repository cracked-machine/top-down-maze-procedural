#ifndef SRC_COMPONENTS_RUIN_RUINSTAIRSBALUSTRADEMULTIBLOCK_HPP__
#define SRC_COMPONENTS_RUIN_RUINSTAIRSBALUSTRADEMULTIBLOCK_HPP__
...
#endif // SRC_COMPONENTS_RUIN_RUINSTAIRSBALUSTRADEMULTIBLOCK_HPP__
