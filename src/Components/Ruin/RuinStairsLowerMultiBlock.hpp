#ifndef SRC_COMPONENTS_RUIN_RUINSTAIRSLOWERMULTIBLOCK_HPP__
#define SRC_COMPONENTS_RUIN_RUINSTAIRSLOWERMULTIBLOCK_HPP__
...
#endif // SRC_COMPONENTS_RUIN_RUINSTAIRSLOWERMULTIBLOCK_HPP__
