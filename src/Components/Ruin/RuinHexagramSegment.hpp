#ifndef SRC_COMPONENTS_RUIN_RUINHEXAGRAMSEGMENT_HPP__
#define SRC_COMPONENTS_RUIN_RUINHEXAGRAMSEGMENT_HPP__
...
#endif // SRC_COMPONENTS_RUIN_RUINHEXAGRAMSEGMENT_HPP__
