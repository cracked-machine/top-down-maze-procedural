#ifndef SRC_COMPONENTS_PERSISTENT_ARMEDBLOCKCOLOURBORDER_HPP__
#define SRC_COMPONENTS_PERSISTENT_ARMEDBLOCKCOLOURBORDER_HPP__
...
//! @brief Border colour used to render armed bomb obstacle blocks.
...
public:
  ...
  //! @return std::string the class name "ArmedBlockColourBorder"
...
#endif // SRC_COMPONENTS_PERSISTENT_ARMEDBLOCKCOLOURBORDER_HPP__
