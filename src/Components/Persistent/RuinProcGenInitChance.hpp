#ifndef SRC_CMPS_PERSISTENT_RUINPROCGENINITCHANCE_HPP_
#define SRC_CMPS_PERSISTENT_RUINPROCGENINITCHANCE_HPP_
...
#endif // SRC_CMPS_PERSISTENT_RUINPROCGENINITCHANCE_HPP_
