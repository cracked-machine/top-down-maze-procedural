#ifndef SRC_COMPONENTS_PERSISTENT_SINKHOLESEED_HPP__
#define SRC_COMPONENTS_PERSISTENT_SINKHOLESEED_HPP__

#include <Components/Persistent/BasePersistent.hpp>
namespace Game::Cmp::Persist
{

//! @brief RNG seed used to generate sinkhole placement/shape.
...
public:
  ...
  //! @return std::string the class name "SinkholeSeed"
...
#endif // SRC_COMPONENTS_PERSISTENT_SINKHOLESEED_HPP__
