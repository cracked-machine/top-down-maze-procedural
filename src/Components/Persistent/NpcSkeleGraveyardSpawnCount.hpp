#ifndef SRC_COMPONENTS_PERSISTENT_NPCSKELEGRAVEYARDSPAWNCOUNT_HPP__
#define SRC_COMPONENTS_PERSISTENT_NPCSKELEGRAVEYARDSPAWNCOUNT_HPP__
...
#endif // SRC_COMPONENTS_PERSISTENT_NPCSKELEGRAVEYARDSPAWNCOUNT_HPP__
