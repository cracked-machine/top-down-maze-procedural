#ifndef SRC_CMPS_PERSISTENT_GRAVEYARDPROCGENINITCHANCE_HPP_
#define SRC_CMPS_PERSISTENT_GRAVEYARDPROCGENINITCHANCE_HPP_
...
#endif // SRC_CMPS_PERSISTENT_GRAVEYARDPROCGENINITCHANCE_HPP_
