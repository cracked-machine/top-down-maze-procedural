#ifndef SRC_CMPS_PERSISTENT_POSTPULLMOVEMENTDELAY_HPP_
#define SRC_CMPS_PERSISTENT_POSTPULLMOVEMENTDELAY_HPP_
...
#endif // SRC_CMPS_PERSISTENT_POSTPULLMOVEMENTDELAY_HPP_