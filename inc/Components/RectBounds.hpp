...
public:
      ...
      : m_scale_factor( ScaleFactor )
  {
    ...
    m_bounds.position = position - sf::Vector2f{ Sprites::MultiSprite::kDefaultSpriteDimensions } * POSITION_OFFSET;
  }

  void position( sf::Vector2f new_position )
  {
    m_bounds.position = new_position - sf::Vector2f{ Sprites::MultiSprite::kDefaultSpriteDimensions } * POSITION_OFFSET;
  }
