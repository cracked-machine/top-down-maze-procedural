#ifndef __CMP__SHRINE_SPRITE_HPP__
#define __CMP__SHRINE_SPRITE_HPP__
...
{
public:
  ShrineSprite( Sprites::SpriteMetaType type, std::size_t tile_index, bool solid_mask )
      : m_type( type ),
...
#endif // __CMP__SHRINE_SPRITE_HPP__