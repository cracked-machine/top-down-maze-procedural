...
public:
    ...
    {
        std::string result;
        if( dir == Dir::UP) result = "UP";
        else if (dir == Dir::DOWN) result = "DOWN";
        else if (dir == Dir::LEFT) result = "LEFT";
        else if (dir == Dir::RIGHT) result = "RIGHT";
        else if (dir == Dir::UP_LEFT) result = "UP_LEFT";
        else if (dir == Dir::UP_RIGHT) result = "UP_RIGHT";
        else if (dir == Dir::DOWN_LEFT) result = "DOWN_LEFT";
        else if (dir == Dir::DOWN_RIGHT) result = "DOWN_RIGHT";
        else SPDLOG_ERROR("Unknown direction: {}", static_cast<int>(dir));
        return result;
    }
    void clear()
    {
    ...
    void remove(Dir dir)
    {
        ...
        {
            SPDLOG_WARN("Attempted to remove non-existent entity in direction: {}", static_cast<int>(dir));
        }
    }
