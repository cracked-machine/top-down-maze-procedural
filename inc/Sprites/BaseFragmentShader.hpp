...
//                  Extra arguments should be passed to the derived class constructor and stored as members.
// - `post_setup`:    Handles texture post-initialization. 
//                  Extra arguments should be passed to the derived class constructor and stored as members.
// - `update`:        Handles runtime updates. The base class does not call this function so you must call it 
//                  from your game loop. Add more functions to your derived class if you need them.
