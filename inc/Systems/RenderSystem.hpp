...
public:
      ...
      : BaseSystem( reg ), m_path_find_sys( path_find_sys )
  {
    ...
    m_minimap_view = sf::View(
        { MINI_MAP_VIEW_SIZE.x * 0.5f, MINI_MAP_VIEW_SIZE.y * 0.5f }, MINI_MAP_VIEW_SIZE
    );
...
private:
  ...
  void render_walls()
  {
    ...
    for ( auto [entity, _ob, _pos] :
          m_position_updates.view<Cmp::Obstacle, Cmp::Position>( entt::exclude<Cmp::Neighbours> )
              .each() )
    {
  ...
  void render_npc()
  {
    for ( auto [entity, npc, pos, npc_scan_bounds, direction] :
          m_position_updates.view<Cmp::NPC, Cmp::Position, Cmp::NPCScanBounds, Cmp::Direction>()
              .each() )
    {
      // flip and x-axis offset the sprite depending on the direction
      if ( direction.x > 0 )
...
private:
  ...
  std::optional<Sprites::MultiSprite> m_rock_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::ROCK );
  std::optional<Sprites::MultiSprite> m_pot_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::POT );
  std::optional<Sprites::MultiSprite> m_bone_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::BONES );
  std::optional<Sprites::MultiSprite> m_detonation_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::DETONATED );
  std::optional<Sprites::MultiSprite> m_bomb_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::BOMB );
  std::optional<Sprites::MultiSprite> m_wall_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::WALL );
  std::optional<Sprites::MultiSprite> m_player_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::PLAYER );
  std::optional<Sprites::MultiSprite> m_npc_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::NPC );

  std::optional<Sprites::MultiSprite> m_extra_health_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::EXTRA_HEALTH );
  std::optional<Sprites::MultiSprite> m_extra_bombs_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::EXTRA_BOMBS );
  std::optional<Sprites::MultiSprite> m_infinite_bombs_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::INFINI_BOMBS );
  std::optional<Sprites::MultiSprite> m_chain_bombs_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::CHAIN_BOMBS );
  std::optional<Sprites::MultiSprite> m_lower_water_ms =
      m_sprite_factory->get_multisprite_by_type( Sprites::SpriteFactory::Type::LOWER_WATER );
